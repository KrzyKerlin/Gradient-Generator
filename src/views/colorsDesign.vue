    ...
    <v-row class="fill-height mx-2 md-mx-8">
      ...
      >
        <h1
          ...
          class="text-h3 text-md-h1 text-center font-weight-bold my-2"
        >
          HEADING TEXT
        </h1>
        <p
          :style="{ color: textColor }"
          class="text-h6 text-md-h5 text-center my-2"
        >
      ...
      >
        <v-card
          class="pa-6 text-center bg-white lighten-3 elevation-10 rounded-lg"
        >
          <v-row class="mb-2">
            ...
            <v-col cols="6" class="d-flex flex-column align-center">
              <label for="textColor" style="white-space: nowrap"
                >Txt Color</label
              >
              <input
                type="color"
            ...
            <!-- Button Color Picker -->
            <v-col cols="6" class="d-flex flex-column align-center">
              <label for="buttonBgColor" style="white-space: nowrap"
                >Button Bg</label
              >
              <input
                type="color"
            ...
            <v-col cols="6" class="d-flex flex-column align-center">
              <label for="buttonTextColor" style="white-space: nowrap"
                >Button Txt</label
              >
              <input
                type="color"
...
watch(
  [bgColor, textColor, buttonBgColor, buttonTextColor, socialColor],
  () => {
    document.body.style.background = bgColor.value;
  },
  { immediate: true },

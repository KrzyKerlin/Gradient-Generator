<template>
  <v-container class="fill-height d-flex align-center justify-center">
    ...
    <v-card class="mx-auto pa-6 text-center" max-width="500" elevation="10">
      ...
      <v-sheet
        class="gradient-code relative bg-blue-grey-darken-4 text-white mt-6 pa-3 rounded-lg overflow-hidden"
      >
...
watch([color1, color2, color3, direction, showThirdColor], updateGradient, {
  immediate: true,
});

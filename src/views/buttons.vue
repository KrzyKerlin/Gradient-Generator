...
onMounted(() => {
  document.body.style.background =
    "linear-gradient(to right, #80def4, #5db9d0, #0b88a8)";
});
...
.shadow3D-button {
  ...
  transition-property:
    border-top, border-left, border-bottom, border-right, box-shadow;
}
